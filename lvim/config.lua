...
-- lvim.keys.terminal_mode["<C-t>"] = ":TermExec cmd=exit"
...
lvim.builtin.lualine.options.globalstatus = true -- sets 'set laststatus=3'
...
-- Change default theme for Telescope when opening from buffer
lvim.builtin.which_key.mappings["f"] = {
  ":Telescope find_files theme=dropdown previewer=false<CR>",
  "Find files"
}

-- TODO: this breaks after installing LunarVim v0.8.0+, ¿remove if
-- no longer needed?
-- Change default theme for Telescope when opening from alpha-nvim
...
linters.setup {
  ...
  },
  {
    command = "codespell",
    ---@usage specify which filetypes to enable. By default a providers will attach to all the filetypes it supports.
    -- filetypes = { "javascript", "typescript", "python", "typescriptreact" },
  },
  { command = "stylelint" }
}
