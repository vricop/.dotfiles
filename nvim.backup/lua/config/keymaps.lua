...
map('n', '<Leader>da', '<cmd>bufdo bd<cr>', {
...
map('n', '<Leader>r', ':%s@\\v<<C-r><C-w>>@@gc<Left><Left><Left>', {
...
map('n', '<Leader>R', function()
  ...
  desc = 'Find & replace from buffer list',
  silent = false,
  expr = true,
})

map('n', '<Leader>fk', ':map<Cr>', {
  desc = 'Find keymaps',
  silent = true,
})

map('n', '<Leader>fr', ':registers<Cr>', {
  desc = 'Find registers',
  silent = true,
})
