...
map("n", "<Leader>da", "<cmd>bufdo bd<cr>", { desc = "Delete all buffers", silent = true })
...
map("n", "<Leader>k", ":map<Cr>", { desc = "Find keymaps", silent = true })
map("n", "<Leader>@", ":registers<Cr>", { desc = "Find registers", silent = true })
map("n", "<Leader>'", ":marks<Cr>", { desc = "Find marks", silent = true })
